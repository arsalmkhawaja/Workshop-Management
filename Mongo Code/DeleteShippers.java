...
public class DeleteShippers extends JFrame {
    ...
    public DeleteShippers() {
        ...
        JLabel lblEnterTheSupplier = new JLabel("Enter the shipper ID of the shipper you want to delete from the shipper list");
        ...
        btnNewButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    MongoCollection ship = db.getCollection("shipper");
                    Document sampleDoc = new Document("shipper_id",Integer.parseInt(sid.getText()));
                    ship.deleteOne(sampleDoc);
