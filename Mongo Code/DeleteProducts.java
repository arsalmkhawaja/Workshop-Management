...
public class DeleteProducts extends JFrame {
    ...
    public DeleteProducts() {
        ...
        JLabel lblDeleteFromSuppliers = new JLabel("DELETE FROM PRODUCTS");
        ...
        JLabel lblEnterTheSupplier = new JLabel("Enter the Product ID of the product you want to delete from the product list");
        ...
        JLabel lblSupplierId = new JLabel("Product ID:");
        ...
        btnNewButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    MongoCollection prod = db.getCollection("products");
                    Document sampleDoc = new Document("product_id",Integer.parseInt(sid.getText()));
                    prod.deleteOne(sampleDoc);
                    JOptionPane.showMessageDialog(null, "ID: " + (sid.getText()) +" Deleted from the product list!");
                    int choose=0;
