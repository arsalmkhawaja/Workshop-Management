...
public class SearchWorkers extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    SearchWorkers frame = new SearchWorkers();
    ...
    public SearchWorkers() {
        ...
        JLabel lblNewLabel = new JLabel("SEARCH WORKERS");
        lblNewLabel.setFont(new Font("Poppins", Font.BOLD, 18));
        lblNewLabel.setBounds(188, 11, 196, 16);
        contentPane.add(lblNewLabel);

        JLabel lblEnterProductId = new JLabel("Enter Worker ID of the Worker you want to search");
        ...
        JLabel lblProductId = new JLabel("Worker ID:");
        ...
        btnNewButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                p_id = pid.getText();
                SearchWorkersTable field = new SearchWorkersTable();
