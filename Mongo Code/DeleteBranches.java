...
public class DeleteBranches extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    DeleteBranches frame = new DeleteBranches();
    ...
    public DeleteBranches() {
        ...
        JLabel lblDeleteFromSuppliers = new JLabel("DELETE FROM BRANCHES");
        ...
        JLabel lblEnterTheSupplier = new JLabel("Enter the Branch ID of the branch you want to delete from the branch list");
        ...
        JLabel lblSupplierId = new JLabel("Branch ID:");
        ...
        btnNewButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    Document sampleDoc = new Document("branch_id",Integer.parseInt(sid.getText()));
                    bran.deleteOne(sampleDoc);
                    JOptionPane.showMessageDialog(null, "ID: " + (sid.getText()) +" Deleted from the branch list!");
                    int choose=0;
