...
public class SearchShippers extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    SearchShippers frame = new SearchShippers();
    ...
    public SearchShippers() {
        ...
        JLabel lblNewLabel = new JLabel("SEARCH SHIPPERS");
        lblNewLabel.setFont(new Font("Poppins", Font.BOLD, 18));
        lblNewLabel.setBounds(188, 11, 196, 16);
        contentPane.add(lblNewLabel);

        JLabel lblEnterProductId = new JLabel("Enter shipper ID of the shipper you want to search");
        ...
        JLabel lblProductId = new JLabel("Shipper ID:");
        ...
        btnNewButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                p_id = pid.getText();
                SearchShippersTable field = new SearchShippersTable();
