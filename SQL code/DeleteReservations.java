...
public class DeleteReservations extends JFrame {
    ...
    public DeleteReservations() {
        ...
        JLabel lblEnterTheSupplier = new JLabel(
                "Enter the Reservation ID of the reservations you want to delete from the reservations");
        ...
        btnNewButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    String sql = "DELETE FROM reservations WHERE reservations_id='" + (sid.getText() + "';");
                    PreparedStatement pst = connection.prepareStatement(sql);

                    pst.executeUpdate();
                    JOptionPane.showMessageDialog(null,
                            "ID: " + (sid.getText()) + " Deleted from the reservations list!");
                    int choose = 0;
