...
public class SearchProducts extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    SearchProducts frame = new SearchProducts();
    ...
    public SearchProducts() {
        ...
        JLabel lblEnterProductId = new JLabel("Enter Product ID of the Product you want to search");
        ...
        btnNewButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                p_id = pid.getText();
                SearchProductsTable field = new SearchProductsTable();
